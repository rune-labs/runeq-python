...
New versions of Rune's API and SDK was released in January 2023, in combination with our new data pipeline. These function quite differently from our legacy API/SDK, so new tutorial/example notebooks are available in this repo.

This archive contains some introductory materials to access and manipulate data using Rune's **legacy** API.
