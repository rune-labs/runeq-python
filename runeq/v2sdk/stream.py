...
def get_stream(stream_id: str, limit: int = 100, format: str = "csv"):
    """
    ...
    With a 'csv' format, each iteration of the generator returns column
    names and up to 'limit' rows of data. For example:
    ...
    With a 'json' format, each iteration of the generator returns cardinality
    and data fields. For example:
...
def get_availability(stream_id: str, limit: int = 100, format: str = "csv"):
    """
    ...
    With a 'csv' format, each iteration of the generator returns a csv with
    column names and up to 'limit' rows of data. For example:
    ...
    With a 'json' format, each iteration of the generator returns a json with
    cardinality and data fields. For example:
